...
const Movies = () => {
  ...
  return (
    ...
    <div className='my-3' style={{width: '1000px', margin: 'auto'}}>
        ...
        <button onClick={()=>filterByCategory("Action")} type="button" className="btn btn-outline-danger mx-3">Action</button>
        <button onClick={()=>filterByCategory("Thriller")} type="button" className="btn btn-outline-light mx-3">Thiller</button>
